...
//     // ✅ Player overlays – ICON colored by user_id
...
//             width: `${cellW}%`,
//             height: `${cellH}%`,
//             top: `${p.row * cellH}%`,     // ✅ FIXED POSITION
//             left: `${p.col * cellW}%`,    // ✅ FIXED POSITION
...
//           <User
//             size={Math.min(cellW, cellH) * 0.7}   // ✅ ICON SIZE FITS CELL
//             stroke={color}                          // ✅ COLORED BY USER-ID
//             strokeWidth={3}
//           />
//         </div>
//       );
