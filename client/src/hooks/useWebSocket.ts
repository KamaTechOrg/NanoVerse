...
// /**
//  * Decide backend host:
//  * - in dev: ws://127.0.0.1:8080/game/ws
//  * - in prod: ws(s)://<actual-host>/game/ws
//  */
...
// // 🧩 keep global singleton socket across re-renders & remounts
...
//     return () => {
//       // only close if this hook truly unmounts app-wide (rare)
